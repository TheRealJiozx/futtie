...
<nav class="container-fluid">
    <ul>
      <a href="main.php"><li class="main">FUTTIE CENTRAL</li></a><a href="play.php"><li class="main">PLAY</li></a><a href="online.php"><li class="main">ONLINE</li></a><a href="squads.php"><li class="active"><b>SQUADS</b></li></a><a href="transfers.php"><li class="main">TRANSFERS</li></a><a href="store.php"><li class="main">STORE</li></a><a href="club.php"><li class="right">MY CLUB</li></a>
    </ul>
</nav>
<div id="menu-wrapper">
  <section id="big-menu" class="container-fluid">
    <div class="d-flex flex-row">
      <a href="squads/mysquad.php"><div class="p-0 item first-squads">
        <h2>ACTIVE SQUAD</h2>
      </div></a>
      <a href="sbc/main.php"><div class="p-0 item second-squads">
        <h2>SQUAD BUILDING CHALLENGES</h2>
      </div></a>
    </div>
    <div class="d-flex flex-row">
      <a href="fans/totw.php"><div class="p-0 item third-squads">
        <h2>FANS' TOTW</h2>
      </div></a>
    </div>
  </section>
