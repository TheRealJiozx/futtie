...
<nav class="container-fluid">
    <ul>
      <a href="main.php"><li class="main">FUTTIE CENTRAL</li></a><a href="play.php"><li class="main">PLAY</li></a><a href="online.php"><li class="main">ONLINE</li></a><a href="squads.php"><li class="main">SQUADS</li></a><a href="transfers.php"><li class="main">TRANSFERS</li></a><a href="store.php"><li class="active"><b>STORE</b></li></a><a href="club.php"><li class="right">MY CLUB</li></a>
    </ul>
</nav>
<div id="menu-wrapper">
  <section id="big-menu" class="container-fluid">
    <div class="d-flex flex-row">
      <a href="store/packs.php"><div class="p-0 item first-play">
        <h2>BROWSE PACKS</h2>
      </div></a>
      <a href="diamonds/store.php"><div class="p-0 item second-play">
        <h2>BUY WITH DIAMONDS</h2>
      </div></a>
    </div>
    <div class="d-flex flex-row">
      <a href="news/main.php"><div class="p-0 item third-play">
        <h2>NEWS</h2>
      </div></a>
    </div>
  </section>
