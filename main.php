...
<nav class="container-fluid">
    <ul>
      <li class="active"><b>FUTTIE CENTRAL</b></li><a href="play.php"><li class="main">PLAY</li></a><a href="online.php"><li class="main">ONLINE</li></a><a href="squads.php"><li class="main">SQUADS</li></a><a href="transfers.php"><li class="main">TRANSFERS</li></a><a href="store.php"><li class="main">STORE</li></a><a href="club.php"><li class="right">MY CLUB</li></a>
    </ul>
</nav>
<div id="menu-wrapper">
  <section id="big-menu" class="container-fluid">
    <div class="d-flex flex-row">
      <a href="objectives/main.php"><div class="p-0 item first">
        <h2>OBJECTIVES</h2>
      </div></a>
      <a href="objectives/news.php"><div class="p-0 item second">
        <h2>HIGHLIGHTED NEWS</h2>
      </div></a>
    </div>
    <div class="d-flex flex-row">
      <a href="futtie/rankings.php"><div class="p-0 item third">
        <h2>FUTTIE RANKINGS</h2>
      </div></a>
      <a href="news/main.php"><div class="p-0 item fourth">
        <h2>NEWS</h2><center><div class="news"><img src="store/img/messi.png" width="100" height="150"></img></div></center>
      </div></a>
    </div>
  </section>
