...
<nav role="sub" class="container-fluid">
    <ul>
      <a href=""><li class="active">BRONZE PACKS</li></a><a href="silvers.php"><li class="main">SILVER PACKS</li></a><a href="golds.php"><li class="main">GOLD PACKS</li></a><a href="lightning.php"><li class="main">LIGHTNING ROUND</li></a><a href="futties.php"><li class="main">FUTTIE PACKS</li></a>
    </ul>
</nav>
<div id="menu-wrapper">
  <section id="big-menu-two" class="container-fluid">
    <div class="d-flex flex-row">
      <a href="500cpack.php"><div class="p-0 item-packs first-pack">
        <img src="img/bronze.png"></img><h5>500 Coins <br> or 5 Diamonds</h5>
      </div></a>
      <a href="750cpack.php"><div class="p-0 item-packs second-pack">
        <img src="img/bronze.png"></img><h5>750 Coins <br> or 7 Diamonds</h5>
      </div></a>
	  <a href="900cpack.php"><div class="p-0 item-packs third-pack">
        <img src="img/bronze.png"></img><h5>900 Coins <br> or 9 Diamonds</h5>
      </div></a>
	  <a href="../store.php"><div class="p-0 item-packs fourth-pack"><h1>GO BACK</h1>
      </div></a>
    </div>
  </section>
