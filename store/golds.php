...
<nav role="sub" class="container-fluid">
    <ul>
      <a href="packs.php"><li class="main">BRONZE PACKS</li></a><a href="silvers.php"><li class="main">SILVER PACKS</li></a><a href=""><li class="active">GOLD PACKS</li></a><a href="lightning.php"><li class="main">LIGHTNING ROUND</li></a><a href="futties.php"><li class="main">FUTTIE PACKS</li></a>
    </ul>
</nav>
<div id="menu-wrapper">
  <section id="big-menu-two" class="container-fluid">
    <div class="d-flex flex-row">
      <a href="5k.php"><div class="p-0 item-packs first-pack-golds">
        <img src="img/gold.png"></img><h5>5000 Coins <br> 50 Diamonds</h5>
      </div></a>
      <a href="7kpack.php"><div class="p-0 item-packs second-pack-golds">
        <img src="img/gold.png"></img><h5>7000 Coins <br> or 70 Diamonds</h5>
      </div></a>
	  <a href="10kpack.php"><div class="p-0 item-packs third-pack-golds">
        <img src="img/gold.png"></img><h5>10000 Coins <br> or 100 Diamonds</h5>
      </div></a>
	  <a href="../store.php"><div class="p-0 item-packs fourth-pack-golds"><h1>GO BACK</h1>
      </div></a>
    </div>
  </section>
